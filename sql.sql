...
INSERT INTO admins (email, password_hash, center_name) VALUES
(
    'superadmin@iik.org.za',
    'admin123',
    'Richmond Centers'
),
(
    'admin.ixopo@iik.org.za',
    'Admin124',
    'Ixopo Center'
),
(
    'admin.Pon@iik.org.za',
    'Admin125',
    'Pongola Center'
),
(
    'admin.dbn@iik.org.za',
    'Admin126',
    'Durban Center'
);

-- Verify
SELECT admin_id, email, center_name FROM admins;
SHOW TABLES;
DESCRIBE admins;
select *from admins;
